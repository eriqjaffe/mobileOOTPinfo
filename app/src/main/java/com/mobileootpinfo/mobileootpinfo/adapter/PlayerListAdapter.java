...
public class PlayerListAdapter extends ArrayAdapter<ShortPlayer> implements SectionIndexer {
    ...
    public PlayerListAdapter(@NonNull Context context, List<ShortPlayer> list, String html, String league) {
