...
public class BattingLineAdapter extends ArrayAdapter<BattingLineScore> {
    ...
    public BattingLineAdapter(@NonNull Context context, List<BattingLineScore> list, String html) {
