 ...
 */
public class CalligraphyDefault4TabLayout extends TabLayout {
    ...
    public CalligraphyDefault4TabLayout(Context context) {
        super(context);
        initCalligraphyTypeface();
        initTabMinWidth();
    }

    public CalligraphyDefault4TabLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initCalligraphyTypeface();
        initTabMinWidth();
    }

    public CalligraphyDefault4TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
